...
async function setBarangayList() {
  ...
  if(district.value == ""){
    ...
    fetch("http://138.2.84.62:5000/getBarangay/" + district.value)
    .then((response) => response.json())
    .then((data) => {
...
async function getPerims(callback) {
  await fetch("http://138.2.84.62:5000/getPerimeters")
  .then((response) => response.json())
  .then((data) => {
...
async function setPerimeterImage(image, image_type) {
  await fetch("http://138.2.84.62:5000/checkImage?image_type=" + image_type)
  .then((response) => response.json())
  .then((data) => {
    if (data.error) {
...
async function deleteImage(data) {
  await fetch("http://138.2.84.62:5000/delete?path_find=" + data.path_find)
    .then((response) => {
      if (response.ok) {
...
async function insertImage(image, image_type) {
  ...
  if (file) {
    ...
    fetch("http://138.2.84.62:5000/upload", {
      method: "POST",
      body: formData,
    })
    .then((response) => response.json())
...
async function updateImage(image, image_type) {
  ...
  if (file) {
    ...
    fetch("http://138.2.84.62:5000/update", {
      method: "PUT",
      body: formData,
    })
    .then((response) => response.json())
...
async function deleteSignature(image_type) {
  await fetch("http://138.2.84.62:5000/deleteImage?image_type=" + image_type)
  .then((response) => response.json())
  .then((data) => {
    if (data.error) {
...
save_button.addEventListener("click", async () => {
  ...
  await fetch("http://138.2.84.62:5000/updatePerimeters", {
    method: "POST",
    headers: {
...
delete_prep.addEventListener("click", async () => {
  await fetch("http://138.2.84.62:5000/checkImage?image_type=" + perimeter_preparer_signature.id)
  .then((response) => response.json())
  .then((data) => {
    if (data.error) {
...
delete_ver.addEventListener("click", async () => {
  await fetch("http://138.2.84.62:5000/checkImage?image_type=" + perimeter_verifier_signature.id)
  .then((response) => response.json())
  .then((data) => {
    if (data.error) {
      console.log("There are no existing image for this field");
...
delete_app.addEventListener("click", async () => {
  await fetch("http://138.2.84.62:5000/checkImage?image_type=" + perimeter_approver_signature.id)
  .then((response) => response.json())
  .then((data) => {
    if (data.error) {
      console.log("There are no existing image for this field");
